 ...
 */
final class Version20221121093646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, id_membre_id INT DEFAULT NULL, date_commande DATETIME NOT NULL, date_arrivee DATETIME DEFAULT NULL, INDEX IDX_6EEAA67DEAAC4B6D (id_membre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
